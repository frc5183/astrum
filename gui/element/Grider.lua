...
function Grider:initialize(x, y, tilewidth, tileheight, xspacing, yspacing, gridwidth, gridheight, color, extendmode, twidth, theight)
    ...
    assert(extendmode == "down" or extendmode == "right" or extendmode== "error" or extendmode=="alternate", "You must include a valid extendmode: dowm, right, error, alternate")
    if (twidth) then
    ...
    self.container = Container(x, y, twidth, theight, color, (tilewidth+xspacing)*gridwidth-xspacing, (tileheight+yspacing)*gridheight-yspacing)
...
function Grider:TextInput(xwidth, yheight, color, text, fontsize, align, textcolor, internalcolor)
    safety.ensureIntegerOver(xwidth, 0, "xwidth")
    safety.ensureIntegerOver(yheight, 0, "yheight")
    ...
    local t = TextInput(((self.tilewidth+self.xspacing) * (ox-1)), ((self.tileheight+self.yspacing)*(oy-1)), owidth, oheight, color, text, fontsize, align, textcolor, internalcolor)
    for x=ox, ox+xwidth-1 do
        for y=oy, oy+yheight-1 do
            self.grid:set(x, y, t)
        end
    end
...
function Grider:AdapterButton(xwidth, yheight)
    ...
    local owidth = (self.tilewidth+self.xspacing)*xwidth-self.xspacing
    local oheight = (self.tileheight+self.yspacing)*yheight-self.yspacing
    local t = AdapterButton(((self.tilewidth+self.xspacing) * (ox-1)), ((self.tileheight+self.yspacing)*(oy-1)), owidth, oheight)
    for x=ox, ox+xwidth-1 do
        for y=oy, oy+yheight-1 do
            self.grid:set(x, y, t)
        end
...
function Grider:Checkbox(xwidth, yheight, color, internalcolor, selectedcolor)
    ...
    local owidth = (self.tilewidth+self.xspacing)*xwidth-self.xspacing
    local oheight = (self.tileheight+self.yspacing)*yheight-self.yspacing
    local t = Checkbox(((self.tilewidth+self.xspacing) * (ox-1)), ((self.tileheight+self.yspacing)*(oy-1)), owidth, oheight, color, internalcolor, selectedcolor)
    for x=ox, ox+xwidth-1 do
        for y=oy, oy+yheight-1 do
            self.grid:set(x, y, t)
        end
...
function Grider:Grider(xwidth, yheight, tilewidth, tileheight, xspacing, yspacing, gridwidth, gridheight, color, extendmode)
    safety.ensureIntegerOver(xwidth, 0, "xwidth")
    safety.ensureIntegerOver(yheight, 0, "yheight")
    local ox, oy = self:ClearRoom(xwidth, yheight)
    local owidth = (self.tilewidth+self.xspacing)*xwidth-self.xspacing
    local oheight = (self.tileheight+self.yspacing)*yheight-self.yspacing
    local t = Grider(((self.tilewidth+self.xspacing) * (ox-1)), ((self.tileheight+self.yspacing)*(oy-1)), tilewidth, tileheight, xspacing, yspacing, gridwidth, gridheight, color, extendmode, owidth, oheight)
    for x=ox, ox+xwidth-1 do
        for y=oy, oy+yheight-1 do
            self.grid:set(x, y, t)
        end
...
function Grider:ScrollBar(xwidth, yheight, percentage, color, isVertical)
    ...
    local owidth = (self.tilewidth+self.xspacing)*xwidth-self.xspacing
    local oheight = (self.tileheight+self.yspacing)*yheight-self.yspacing
    local t = ScrollBar(((self.tilewidth+self.xspacing) * (ox-1)), ((self.tileheight+self.yspacing)*(oy-1)), owidth, oheight, percentage, color, isVertical)
    for x=ox, ox+xwidth-1 do
        for y=oy, oy+yheight-1 do
            self.grid:set(x, y, t)
        end
...
function Grider:TextButton(xwidth, yheight, color, text, fontsize, align, textcolor, internalcolor)
    safety.ensureIntegerOver(xwidth, 0, "xwidth")
    safety.ensureIntegerOver(yheight, 0, "yheight")
    local ox, oy = self:ClearRoom(xwidth, yheight)
    local owidth = (self.tilewidth+self.xspacing)*xwidth-self.xspacing
    local oheight = (self.tileheight+self.yspacing)*yheight-self.yspacing
    local t = TextButton(((self.tilewidth+self.xspacing) * (ox-1)), ((self.tileheight+self.yspacing)*(oy-1)), owidth, oheight, color, text, fontsize, align, textcolor, internalcolor)
    for x=ox, ox+xwidth-1 do
        for y=oy, oy+yheight-1 do
            self.grid:set(x, y, t)
        end
...
function Grider:TextRectangle(xwidth, yheight, color, text, fontsize, align, textcolor, internalcolor)
    safety.ensureIntegerOver(xwidth, 0, "xwidth")
    safety.ensureIntegerOver(yheight, 0, "yheight")
    local ox, oy = self:ClearRoom(xwidth, yheight)
    print (ox, oy)
    local owidth = (self.tilewidth+self.xspacing)*xwidth-self.xspacing
    local oheight = (self.tileheight+self.yspacing)*yheight-self.yspacing
    local t = TextRectangle(((self.tilewidth+self.xspacing) * (ox-1)), ((self.tileheight+self.yspacing)*(oy-1)), owidth, oheight, color, text, fontsize, align, textcolor, internalcolor)
    for x=ox, ox+xwidth-1 do
        for y=oy, oy+yheight-1 do
            self.grid:set(x, y, t)
        end
...
function Grider:VisualButton(xwidth, yheight, color, internalcolor)
    ...
    local owidth = (self.tilewidth+self.xspacing)*xwidth-self.xspacing
    local oheight = (self.tileheight+self.yspacing)*yheight-self.yspacing
    local t = VisualButton(((self.tilewidth+self.xspacing) * (ox-1)), ((self.tileheight+self.yspacing)*(oy-1)), owidth, oheight, color, internalcolor)
    for x=ox, ox+xwidth-1 do
        for y=oy, oy+yheight-1 do
            self.grid:set(x, y, t)
        end
...
function Grider:draw()
    self.container:draw()
end
function Grider:update(dt, pt)
    self.container:update(dt, pt)
end
function Grider:textinput(text)
...
function Grider:wheelmoved(dx, dy, x, y)
    self.container:wheelmoved(dx, dy, x, y)
end
