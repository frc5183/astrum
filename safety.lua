...
---@param val any
---@param name string|nil
function safety.ensureTable(val, name) safety.ensureLuaType(val, "table", name) end

--- Ensures that a certain named value is a number
---@param val any
---@param name string|nil
function safety.ensureNumber(val, name) safety.ensureLuaType(val, "number", name) end

--- Ensures that a certain named value is nil
---@param val any
---@param name string|nil
function safety.ensureNil(val, name) safety.ensureLuaType(val, "nil", name) end
...
function safety.ensureInteger(val, name)
  ...
  if (val ~= math.floor(val)) then error(name .. " must be an integer value") end
end
...
function safety.ensureInstanceType(val, class, name)
  ...
  if (type(val.isInstanceOf) == "function") then
    if (val:isInstanceOf(class)) then return end
  end
